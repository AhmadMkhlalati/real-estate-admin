  ...
  <v-app id="inspire">
   <v-stepper
    ...
    <v-stepper-header>
     <v-stepper-step
      :complete="e1 > 1"
      step="1">Company Information</v-stepper-step>

     <v-divider></v-divider>

     <v-stepper-step
      :complete="e1 > 2"
      step="2">Directors</v-stepper-step>
     ...
     <v-stepper-content step="1">
      <form data-vv-scope="form1">
       ...
       <v-row>
        <v-col cols="3">
         <v-text-field
          v-model="Proposed_Company_Name_I"
       ...
       <v-row>
        <v-col cols="3">
         ...
         <v-text-field
          v-model="Principal_Business_Activity_I"
        ...
        <v-col cols="3">
         <v-text-field
          v-model="Principal_Business_Activity_II"
       ...
       <v-row>
        <v-col cols="3">
         ...
         <v-select
          ...
          v-model="Paid_Up_Capital_Currency"
        ...
        <v-col cols="3">
         <v-text-field
          v-model="Paid_Up_Capital_Amount"
       ...
       <v-row>
        <v-col cols="3">
         ...
         <v-text-field
          v-model="Total_Number_of_Shares"
        ...
        <v-col cols="3">
         <v-text-field
          v-model="Registered_Office_Address"
      ...
      <form data-vv-scope="form2">
       ...
       <div v-for="(director, index) in directors" :key="index">
        ...
        <v-row>
         ...
         <v-col cols="6">
          <v-text-field
           v-model="directors[index].Address"
           label="Address"
      ...
      <form data-vv-scope="form3">
       ...
       <div v-for="(shareholder, index) in shareholders" :key="index">
        ...
        <v-row>
         ...
         <v-col
          cols="3"
          v-if="shareholders[index].isCorpShow">
        ...
        <v-row>
         ...
         <v-col cols="3">
          <v-text-field
           v-model="shareholders[index].Address"
           label="Address"
         ...
         <v-col cols="3">
          <v-text-field
           v-model="shareholders[index].Shares"
           label="Shares"
        ...
        <v-row v-if="shareholders[index].isCorpShow">
         <v-col cols="3">
          <v-text-field
           v-model="shareholders[index].Corporate_Representative_Name"
         ...
         <v-col cols="3">
          <v-text-field
           v-model="shareholders[index].Corporate_Representative_Address"
...
export default {
 ...
 mounted: function () {
  ...
  this.directors = [{ "Name": "John Doe", "ID": "S833", "DOB": this.Financial_Year_End, "Nationality": "AMERICAN", "Email": "johndoe@aol.com", "Phone": "8733", "Address": "Address 1 " },
   { "Name": "Jane Doe", "ID": "SSW22", "DOB": this.Financial_Year_End, "Nationality": "ANGOLAN", "Email": "jane@aol.com", "Phone": "98", "Address": "Address 222 " }
  ];

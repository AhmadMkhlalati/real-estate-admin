<template>
  <v-app-bar
    ...
    <v-img  width="30px" height="30px" max-width="30px" class="mx-5 rounded-circle" src="../../assets/logo.svg"></v-img>
    <v-toolbar-title>Swess Home</v-toolbar-title>
    <v-spacer></v-spacer>
    <!-- <Search /> -->
 ...
 <!-- <v-menu
    ...
    <v-menu
      ...
      nudge-bottom="10">
        ...
        <v-list >
          <div class="text-h5 grey--text text--darken-3 px-4 pt-4">{{User.first_name + ' ' + User.last_name}}</div>
          <div class="subtitle-2 primary--text font-weight-regular px-4">{{User.role}}</div>
          <div class="subtitle-2 primary--text font-weight-regular px-4">{{User.authentication}}</div>
          <!-- <v-list-item-group color="primary">
            <v-list-item
...
import {mapActions, mapState,mapGetters} from 'vuex'
  ...
  export default {
    ...
    methods: {
      ...mapActions([ 'TOGGLE_DRAWER',"userData"]),
      logOut() {
